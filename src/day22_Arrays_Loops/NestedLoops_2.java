...
public class NestedLoops_2 {
    public static void main(String[] args) {
        ...
        int [][] numbers = {   { 9,8,7 }, { 6 }, {  5,4,3,2,1,0  }  };
                    //             0        1            2
       /*      k
       numbers[0] ==> { 9,8,7 }        number[0] [i] i needs to be repeated 3 times
       numbers[1] ==> { 6 }            number[1][i]  i needs to be repeated 1 time
       ...
       for( int k = 0; k < numbers.length; k++){// k : index number of 1D array

           for(int i = numbers[k].length-1; i >= 0;i--){// i : index number of elements in 1D array
               System.out.print(numbers[k][i]+" ");
           }
       }
        System.out.println();
        ...
        for( int k = numbers.length-1; k >= 0; k--){// k : index number of 1D array(reversed)
